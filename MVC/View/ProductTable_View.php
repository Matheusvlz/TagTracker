<?php require '/var/www/html/projetoFinal4/MVC/Controller/ProductTable_Controller.php';?>
<!DOCTYPE html>
<html lang="en">
...
<body>
                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="ProductTable_View.php" class="dropdown-item active">Vizualizar Produtos </a>
    ...
    <h1 class="mb-0">Tabela de Produtos</h1>
        </div>
    <div class="container">
            ...
            <div class="formbg-outer">
              <div class="formbg">
                <div class="formbg-inner padding-horizontal--48">
                  <span class="padding-bottom--15">Apague um produto</span>
                  ...
                  <div class="field padding-bottom--24">
                    <input type="submit" name="acao" value="Apagar Produto">
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="table-container">
        <table>
            ...
            <tbody>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="8">Nenhum produto encontrado para essa empresa.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
  ...
  <div class="form-container" style="visibility: <?php echo ($_SESSION['nivel'] > 1) ? 'visible' : 'hidden'; ?>;">
        ...
        <div class="box-root flex-flex flex-direction--column" style="min-height: 100vh; flex-grow: 1;">
          <div class="box-root padding-top--24 flex-flex flex-direction--column" style="flex-grow: 1; z-index: 9;">
            <div class="formbg-outer">
              <div class="formbg">
                <div class="formbg-inner padding-horizontal--48">
                  <span class="padding-bottom--15">Edite um produto</span>
                  <div class="field padding-bottom--24">
                    <div class="grid--50-50">
    ...
    <?php endif; ?>
                    ...
                    <div class="field padding-bottom--24">
                  <label for="email">Novo Nome do Produto</label>
    ...
    <?php endif; ?>
                  ...
                  <div class="field padding-bottom--24">
                    <input type="submit" name="acao" value="Editar Produto">
                  </div>
                </div>
              </div>
            </div>
