<?php require '/var/www/html/projetoFinal4/MVC/Controller/NewUser_Controller.php';?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="OutputTable_View.php" class="dropdown-item active">Vizualizar Saídas </a>
    ...
    <div class="login-root">
      ...
      <div class="box-root padding-top--24 flex-flex flex-direction--column" style="flex-grow: 1; z-index: 9;">
        <div class="box-root padding-top--48 padding-bottom--24 flex-flex flex-justifyContent--center">
          <h1><a href=" rel="dofollow">Cadastrar Usuário</a></h1>
        </div>
        <div class="formbg-outer">
          <div class="formbg">
            <div class="formbg-inner padding-horizontal--48">
              <span class="padding-bottom--15">Cadastre Um Novo Usuário</span>
         
                <div class="field padding-bottom--24">
                  <label for="email">Nome do Funcionário</label>
                ...
                <div class="field padding-bottom--24">
                  ...
                  <input type="password" name="caixa5">
                </div>
                <div class="grid--50-50">
                    <label for="password">Selecione o Nivel de Acesso</label>
                  </div>
                  <div class="pure-u-1 pure-u-md-1-3">
                <select id="multi-state" class="pure-input-1-2" name="caixa6">
                    <option>1</option>
                    <option>2</option>
                    <option>3</option>
                </select>
