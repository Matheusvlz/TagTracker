<?php require '/var/www/html/projetoFinal4/MVC/Controller/Login_Controller.php';?>
<!DOCTYPE html>
<html lang="en">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    <a href="About_View.php" class="nav-item nav-link">Sobre nós</a>
                </div>
      ...
      <div class="box-root padding-top--24 flex-flex flex-direction--column" style="flex-grow: 1; z-index: 9;">
        ...
        <div class="formbg-outer">
            ...
            <div class="formbg-inner padding-horizontal--48">
              <span class="padding-bottom--15">Entre em Sua Conta</span>
                ...
                <div class="field padding-bottom--24">
                  ...
                  <input type="password" name="caixa2">
                </div>
                <div class="field padding-bottom--24">
          ...
          <div class="footer-link padding-top--24">
            <span>Crie Sua Empresa agora: <a href="SingUp_View.php">Criar Empresa</a></span>
