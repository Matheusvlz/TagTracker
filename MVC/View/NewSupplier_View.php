<?php require '/var/www/html/projetoFinal4/MVC/Controller/NewSupplier_Controller.php';?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="NewSupplier_View.php" class="dropdown-item active" style="visibility: <?php echo ($_SESSION['nivel'] > 1) ? 'visible' : 'hidden'; ?>;">Registrar Fornecedores</a>
    ...
    <div class="login-root">
      ...
      <div class="box-root padding-top--24 flex-flex flex-direction--column" style="flex-grow: 1; z-index: 9;">
        <div class="box-root padding-top--48 padding-bottom--24 flex-flex flex-justifyContent--center">
          <h1><a href="" rel="dofollow">Cadastrar Fornecedor</a></h1>
        </div>
        <div class="formbg-outer">
          <div class="formbg">
            <div class="formbg-inner padding-horizontal--48">
              <span class="padding-bottom--15">Cadastre Um Novo Fornecedor</span>
         
                <div class="field padding-bottom--24">
                  <label for="email">Nome do Fornecedor</label>
