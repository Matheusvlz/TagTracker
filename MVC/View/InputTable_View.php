<?php require '/var/www/html/projetoFinal4/MVC/Controller/InputTable_Controller.php';?>
<!DOCTYPE html>
<html lang="en">
...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="InputTable_View.php" class="dropdown-item active">Vizualizar Entradas</a>
    ...
    <h1 class="mb-0">Tabela de Entrada de Produtos</h1>
        </div>
    <div class="container">
            ...
            <div class="formbg-outer">
              <div class="formbg">
                <div class="formbg-inner padding-horizontal--48">
                  <span class="padding-bottom--15">Apague uma entrada</span>
                  <div class="field padding-bottom--24">
                    <div class="grid--50-50">
                      <label for="produto">UID</label>
                    </div>
                    <div class="pure-u-1 pure-u-md-1-3">
                      ...
                      <?php else: ?>
                        <p>Nenhuma entrada encontrado</p>
                      <?php endif; ?>
                    </div>
                  </div>
                  <div class="field padding-bottom--24">
                    <input type="submit" name="acao" value="Apagar Entrada">
                  </div>
                </div>
              </div>
            </div>
                ...
                <?php if (!empty($tabela)): ?>
                    ...
                    <?php foreach ($tabela as $produto): ?>
                        <tr>
                            ...
                            <td><?= htmlspecialchars($produto['uid']) ?></td>  
                            <td><?= htmlspecialchars($produto['status']) ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr>
                        <td colspan="8">Nenhuma Entrada encontrada para essa empresa.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
