<?php require '/var/www/html/projetoFinal4/MVC/Controller/UserTable_Controller.php';?>
<!DOCTYPE html>
<html lang="en">
...
<body>
                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="UserTable_View.php" class="dropdown-item active" style="visibility: <?php echo ($_SESSION['nivel'] > 2) ? 'visible' : 'hidden'; ?>;">Vizualizar Usuários</a>
                        </div>
                    </div>
    ...
    <h1 class="mb-0">Tabela de Usuários</h1>
        </div>
    <div class="container">
            ...
            <div class="formbg-outer">
              <div class="formbg">
                <div class="formbg-inner padding-horizontal--48">
                  <span class="padding-bottom--15">Apague um Usuário</span>
                  ...
                  <div class="field padding-bottom--24">
                    <input type="submit" name="acao" value="Apagar Usuário">
                  </div>
                </div>
              </div>
            </div>
                ...
                <?php if (!empty($tabela)): ?>
                    ...
                    <?php foreach ($tabela as $produto): ?>
                        <tr>
                            ...
                            <td><?= htmlspecialchars($produto['nome_usuario']) ?></td>
                            <td><?= htmlspecialchars($produto['nivel']) ?></td>  
                            <td><?= htmlspecialchars($produto['email']) ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr>
                        <td colspan="8">Nenhum usuário encontrado para essa empresa.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
  ...
  <div class="form-container">
        ...
        <div class="box-root flex-flex flex-direction--column" style="min-height: 100vh; flex-grow: 1;">
          <div class="box-root padding-top--24 flex-flex flex-direction--column" style="flex-grow: 1; z-index: 9;">
            <div class="formbg-outer">
              <div class="formbg">
                <div class="formbg-inner padding-horizontal--48">
                  <span class="padding-bottom--15">Edite um Usuário</span>
                  <div class="field padding-bottom--24">
                    <div class="grid--50-50">
                      <label for="produto2">Usuário</label>
                    </div>
                    <div class="pure-u-1 pure-u-md-1-3">
                  <?php if (!empty($usuarios)): ?>
        <select name="caixa2">
    ...
    <?php endif; ?>
                ...
                <div class="field padding-bottom--24">
                  <label for="email">Nova Senha do Usuário</label>
                  <input type="password" name="caixa3">
                </div>
                <div class="field padding-bottom--24">
                  <label for="email">Repita a Senha</label>
                  <input type="password" name="caixa4">
                </div>
                <label for="email">Novo Nivel de Acesso</label>
                <select id="multi-state" class="pure-input-1-2" name="caixa5">
                    <option>1</option>
                    <option>2</option>
                    <option>3</option>
                </select>
                  ...
                  <div class="field padding-bottom--24">
                    <input type="submit" name="acao" value="Editar Usuário">
                  </div>
                </div>
              </div>
            </div>
