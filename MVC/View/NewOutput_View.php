<?php require '/var/www/html/projetoFinal4/MVC/Controller/NewOutput_Controller.php';?>
<!DOCTYPE html>
<html lang="en">

<head>
    <meta charset="utf-8">
    <title>Registrar Nova Saída de Produto</title>
                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="NewOutput_View.php" class="dropdown-item active" >Registrar Saídas </a>
    ...
    <div class="login-root">
      ...
      <div class="box-root padding-top--24 flex-flex flex-direction--column" style="flex-grow: 1; z-index: 9;">
        <div class="box-root padding-top--48 padding-bottom--24 flex-flex flex-justifyContent--center">
          <h1><a href=" rel="dofollow">Registrar uma Nova Saida de Produto</a></h1>
        </div>
        <div class="formbg-outer">
          <div class="formbg">
            <div class="formbg-inner padding-horizontal--48">
              <span class="padding-bottom--15">Escaneie a Etiqueta RFID</span>
