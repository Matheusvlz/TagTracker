<?php require '/var/www/html/projetoFinal4/MVC/Controller/OutputTable_Controller.php';?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <h1 class="mb-0">Tabela de Saída de Produtos</h1>
        </div>
    <div class="container">
            ...
            <div class="formbg-outer">
              <div class="formbg">
                <div class="formbg-inner padding-horizontal--48">
                  <span class="padding-bottom--15">Apague uma Saída</span>
                  <div class="field padding-bottom--24">
                    ...
                    <div class="pure-u-1 pure-u-md-1-3">
                      ...
                      <?php else: ?>
                        <p>Nenhuma saída encontrado</p>
                      <?php endif; ?>
                    </div>
                  </div>
                  <div class="field padding-bottom--24">
                    <input type="submit" name="acao" value="Apagar Saída">
                  </div>
                </div>
              </div>
            </div>
